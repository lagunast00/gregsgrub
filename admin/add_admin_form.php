...
**** File Name: admin/add_admin_form.php
**** Description: Form that allows a manager to add another manager to the system
-->
...
<div id="content_container" class="fit8">
    ...
    <h1 class="headings1">Add Manager</h1>
    <div id="add_admin"> 
        ...
        <form id="add_user_form" method="POST" action="index.php">
            ...
            <input type="hidden" name="userLevel" value="A">
            <input type="hidden" name="action" value="add_admin">
        	<input type="submit" value="Add Manager" class="submit_button center">
        </form>
    </div>
</div>
