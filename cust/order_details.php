...
**** File Name: cust/order_details.php
**** Description: Form that shows customer the details of selected order
-->
...
<div id="content_container" class="fit11">
    ...
    <?php if ($order['delivery'] == 'Y') { ?>
        ...
        <a href="//localhost/web289/gregsgrub/cust/index.php?action=view_cart&amp;event=old_cart" class="buttons status">Back</a>
