...
**** File Name: cust/prev_comments.php
**** Description: File that shows all of current customers previous comments
-->
...
<?php 
	...
	$comments = get_my_comments($_SESSION['userID']);

	$comments2 = get_my_comments($_SESSION['userID']);
...
<div id="content_container" class="fit8">
    ...
    <div id="sub_nav">
    	<ul>
			...
			<li><a class="pageMarker" href="http://localhost/web289/gregsgrub/cust/index.php?action=prev_comments">Previous Comments</a></li>
	...
	<h1 class="headings1">My Comments</h1>
...
<?php foreach($comments as $comment) : ?>
	...
	<h3 class="center">No Previous Comments</h3>
