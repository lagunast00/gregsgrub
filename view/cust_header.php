...
**** File Name: view/cust_header.php
**** Description: Customer header
-->
...
if (isset($_SESSION['userLevel'])){
	if ($_SESSION['userLevel'] == 'C') {
		...
		if (isset($_SESSION['orderID']))
			$order1 = get_current_order($_SESSION['orderID']);
	}
	    ...
	    <?php if (isset($_SESSION['userID'])) {
	    	  	if ($_SESSION['userLevel'] == 'C'){ ?>
		    		<div id="cart_header">
						...
						<h2>$<?php if (isset($_SESSION['orderID'])) { echo money($order1['orderSubTotal']); } else echo "0"; ?></h2>
